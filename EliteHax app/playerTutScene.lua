...
local playerTutScene = composer.newScene()
local tutPage=1
---------------------------------------------------------------------------------
...
local close = function(event)
    if (event.phase == "ended") then
        if (tutPage==1) then
            ...
            loadsave.saveTable( tutorialStatus, "playerTutorialStatus.json" )
            tutOverlay = false
...
---------------------------------------------------------------------------------
--  Scene Creation
function playerTutScene:create(event)
    tutGroup = self.view
    ...
    local options = 
    {
        text = "\n\nIn the Profile screen you can see your main stats, including your name, in-game IP Address, player level, XP and the main statistics.",     
...
-- Home Show
function playerTutScene:show(event)
...
--> Listener setup
---------------------------------------------------------------------------------
playerTutScene:addEventListener( "create", playerTutScene )
playerTutScene:addEventListener( "show", playerTutScene )
---------------------------------------------------------------------------------

return playerTutScene