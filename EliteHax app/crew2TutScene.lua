...
local crew2TutScene = composer.newScene()
local tutPage=1
---------------------------------------------------------------------------------
...
local close = function(event)
    if (event.phase == "ended") then
        if (tutPage==1) then
            ...
            loadsave.saveTable( tutorialStatus, "crew2TutorialStatus.json" )
            tutOverlay = false
...
---------------------------------------------------------------------------------
--  Scene Creation
function crew2TutScene:create(event)
    tutGroup = self.view
    ...
    local options = 
    {
        text = "\nFrom the Crew screen you can search and join a Crew or you can create your own Crew!\n\nCrews are important for the game, don't play alone :)",     
...
-- Home Show
function crew2TutScene:show(event)
...
--> Listener setup
---------------------------------------------------------------------------------
crew2TutScene:addEventListener( "create", crew2TutScene )
crew2TutScene:addEventListener( "show", crew2TutScene )
---------------------------------------------------------------------------------

return crew2TutScene