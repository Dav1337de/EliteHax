...
local crewTutScene = composer.newScene()
local tutPage=1
---------------------------------------------------------------------------------
...
local close = function(event)
    if (event.phase == "ended") then
        if (tutPage==1) then
            myData.instruction.text="\n\nBased on your Crew role, you can view and manage other members, handle the requests and change some of the crew settings."
            tutPage=2
        ...
        elseif (tutPage==2) then
            ...
            loadsave.saveTable( tutorialStatus, "crewTutorialStatus.json" )
            tutOverlay = false
...
---------------------------------------------------------------------------------
--  Scene Creation
function crewTutScene:create(event)
    tutGroup = self.view
    ...
    local options = 
    {
        text = "\nWelcome to your Crew!\n\nFrom this screen you can see you crew information including members, score and Crew Wallet!\nYou can also chat with other members.",     
...
-- Home Show
function crewTutScene:show(event)
...
--> Listener setup
---------------------------------------------------------------------------------
crewTutScene:addEventListener( "create", crewTutScene )
crewTutScene:addEventListener( "show", crewTutScene )
---------------------------------------------------------------------------------
