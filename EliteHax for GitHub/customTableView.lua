...
local _momentumScrolling = require( "customMomentumScrolling" )
...
function M.new( options, theme )
	...
	opt.isHorizontalScrollingDisabled = false -- We explicitly disable this as tableViews (aka listViews) only scroll vertically
	opt.isVerticalScrollingDisabled = true
