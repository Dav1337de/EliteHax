<?php
	...
	try {
		...
		$stmt = $db->prepare("INSERT INTO hack_scenario_activities (activity, user_id, host_id, description, start_time, end_time) VALUES (16,?,?,'Exfiltrating data',NOW(),DATE_ADD(NOW(),INTERVAL 60 MINUTE))");
		$stmt->bindValue(1, $id, PDO::PARAM_INT);
