<?php
	...
	try {
		...
		//Insert action with 15 Minutes delay
		$stmt = $db->prepare("INSERT INTO hack_scenario_activities (activity, user_id, vuln_id, description, start_time, end_time) VALUES (10,?,?,'Bruteforce Users and Passwords',NOW(),DATE_ADD(NOW(),INTERVAL 15 MINUTE))");
		$stmt->bindValue(1, $id, PDO::PARAM_INT);
