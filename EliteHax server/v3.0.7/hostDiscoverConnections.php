<?php
	...
	try {
		...
		$stmt = $db->prepare("INSERT INTO hack_scenario_activities (activity, user_id, host_id, description, start_time, end_time) VALUES (13,?,?,'Discovering Connections',NOW(),DATE_ADD(NOW(),INTERVAL 10 MINUTE))");
		$stmt->bindValue(1, $id, PDO::PARAM_INT);
