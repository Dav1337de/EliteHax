<?php
	...
	try {
		...
		//Insert action with 30 Minutes delay
		$stmt = $db->prepare("INSERT INTO hack_scenario_activities (activity, user_id, host_id, description, start_time, end_time) VALUES (15,?,?,'Installing Proxy',NOW(),DATE_ADD(NOW(),INTERVAL 30 MINUTE))");
		$stmt->bindValue(1, $id, PDO::PARAM_INT);
